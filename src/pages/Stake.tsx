...
const SolanaStaking = () => {
    ...
    const handleStakeSol = async () => {
        ...
        setIsStaking(true);
        try {
            const { data } = await axios.post(`http://localhost:3000/stake`, 
                {
            ...
            setTimeout(() => toast.success(`Congratulations 🎉, you have received ${stakeAmount} KSOL, please check your wallet`), 1000)
            setStakeAmount('');
        } catch (error) {
            ...
            <div className="flex-col items-center justify-center w-full">
                <div className="max-w-2xl mx-auto p-4 space-y-6">
                    <div className="rounded-lg shadow-lg overflow-hidden">
                        ...
                        <p className="text-gray-300 mb-6 text-center text-base hidden">🔗 Stake SOL to receive KSOL and earn rewards as you learn and explore</p>
                    ...
                    ${lockPeriod === months
                            ...
                            <div className="grid grid-cols-2 gap-4 border border-[#27272a] rounded-lg p-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="font-medium">1 SOL = 1 KSOL</p>
                                </div>
                                <div className="space-y-1">
                                    <div className="flex items-center gap-2 text-sm text-gray-500">
                                        <Coins className="w-4 h-4" />
